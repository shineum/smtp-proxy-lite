...
if [ -f "/home/sungwon/go/bin/moai" ]; then
	exec "/home/sungwon/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/home/sungwon/.local/bin/moai" ]; then
	exec "/home/sungwon/.local/bin/moai" statusline < "$temp_file"
fi
